...
const FooterLink: React.FC<{onClick: () => void, children: React.ReactNode}> = ({ onClick, children }) => (
    <button onClick={onClick} className="text-gray-400 hover:text-indigo-400 transition-colors duration-200">
        {children}
    </button>
);
...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  return (
    <footer className="w-full mt-8 py-6 border-t border-gray-700">
